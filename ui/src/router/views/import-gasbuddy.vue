...
export default {
  page: {
    title: 'Import GasBuddy',
    meta: [{ name: 'description', content: 'The Import GasBuddy page.' }],
  },
  components: { Layout },
  computed: {
  ...
  methods: {
    importGasBuddy() {
      ...
      axios
        .post(`/api/import/gasbuddy`, formData)
        .then((data) => {
...
<template>
  <Layout>
    <div class="columns box">
      <div class="column">
        <h1 class="title">Import from GasBuddy</h1>
      </div>
    </div>
    <br />
    <div class="columns">
    ...
    <div class="section box">
      <div class="columns">
        ...
        <div class="column is-one-third is-flex is-align-content-center">
          <form @submit.prevent="importGasBuddy">
            <div class="columns"
              ><div class="column">
